...
If GetPicFromIndex(picOriginal, lThisNumber) = False Then GoTo Beginning
...
With Transitions
    Select Case 36 'tProgramOptions.bTransitions(bCurrentTransition)
        Case 1: .Blinds 0
        Case 2: .Blinds 1
        Case 3: .BoxIn
        Case 4: .BoxOut
        ...
        Case 12: .Slide 1
        Case 13: .CrossIn
        Case 14: .RandomLines 0
        Case 15: .RandomLines 1
        Case 16: .MoveOut 0
        Case 17: .MoveOut 1
        Case 18: .Snake 0
        Case 19: .Snake 1
        Case 20: .CircleIn
        Case 21: .FallingLines 0
        Case 22: .FallingLines 1
        Case 23: .FallingLines 2
        Case 24: .FallingLines 3
        Case 25: .Wipe 0
        Case 26: .Wipe 1
        Case 27: .Wipe 2
        Case 28: .Wipe 3
        Case 29: .StretchOut 0
        Case 30: .StretchOut 1
        Case 31: .Shades 0
        Case 32: .Shades 1
        Case 33: .Puzzle
        Case 34: .Sandwich 0
