   ...
   Begin VB.Frame fraSteps 
      ...
      Begin MSComctlLib.ImageList imglstIcons 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3FB7
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":4111
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin MSComctlLib.ImageList imglstDirectory 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   5
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":426B
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":437D
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":448F
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":45A1
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":46B3
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame fraSteps 
      ...
      Begin VB.Frame fraOptions 
         ...
         Begin VB.ListBox lstAvailable 
            ...
            EndProperty
            Height          =   2205
            ItemData        =   "frmMain.frx":4D5E
            Left            =   0
            List            =   "frmMain.frx":4D60
            TabIndex        =   59
            Top             =   735
            WhatsThisHelpID =   56
            Width           =   1695
         ...
         Begin VB.ListBox lstActual 
            ...
            EndProperty
            Height          =   1620
            ItemData        =   "frmMain.frx":4D62
            Left            =   2410
            List            =   "frmMain.frx":4D64
            TabIndex        =   58
            Top             =   1040
            WhatsThisHelpID =   61
            Width           =   1830
...
'Const COLOR_BACK_REG = &H54ACD9
'Const COLOR_BACK_REG = &HFF1515
...
' Holds exactly 8 pictures: two from the previous page,
' the current page, and two for the next page.
Dim tPreviewPics As New Collection
...
With tProgramOptions
    ...
    If tProgramOptions.bNotFirstStart = False Then
        ' If this is the first start, then
    ...
    lblTime.Caption = .iInterval \ 1000 & "  sec"
...
Select Case bTransition
    ...
    Case 11: LookUpTrans = "Diagonal Slide Right"
    Case 12: LookUpTrans = "Diagonal Slide Left"
    Case 13: LookUpTrans = "Cross In"
    Case 14: LookUpTrans = "Random Lines Horizontal"
    Case 15: LookUpTrans = "Random Lines Vertical"
    Case 16: LookUpTrans = "Move Out Horizontal"
    Case 17: LookUpTrans = "Move Out Vertical"
    Case 18: LookUpTrans = "Snake Horizontal"
    Case 19: LookUpTrans = "Snake Vertical"
    Case 20: LookUpTrans = "Circle In"
    Case 21: LookUpTrans = "FallingLines 0"
    Case 22: LookUpTrans = "FallingLines 1"
    Case 23: LookUpTrans = "FallingLines 2"
    Case 24: LookUpTrans = "FallingLines 3"
    Case 25: LookUpTrans = "Wipe 0"
    Case 26: LookUpTrans = "Wipe 1"
    Case 27: LookUpTrans = "Wipe 2"
    Case 28: LookUpTrans = "Wipe 3"
    Case 29: LookUpTrans = "Stretch Out 0"
    Case 30: LookUpTrans = "Stretch Out 1"
    Case 31: LookUpTrans = "Shades 0"
    Case 32: LookUpTrans = "Shades 1"
End Select
...
GetFileName:
        ...
        If sSelectedFiles(0) <> "" Then
            ...
            If LoadSavedList(sSelectedFiles(0), True) = 0 Then
